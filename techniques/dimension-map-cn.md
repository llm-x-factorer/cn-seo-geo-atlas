...
| 卡片 | 主题 | 元假说数 | 最强反话术假说 |
|------|------|---------|---------------|
| [`geo-business-model-taxonomy-cn`](./geo-business-model-taxonomy-cn.md) | GEO 商业模式七层分类 | 6 | A：⭐⭐⭐ LLM 平台一旦自建广告位，c/d 层中介模式整体被腰斩 |
...
平均 4.94 条元假说 / 卡。**全部 79 条仍为 concept 待实证**。
...
| 假说 | 来自 | 打脸什么话术 |
|------|------|--------------|
| **D0** `demand-side` 元假说 C：服务商客户画像越宽，越说明销售在勉强匹配市场 | [`geo-demand-side-fitness-cn`](./geo-demand-side-fitness-cn.md) | "GEO 适用所有行业 / 所有企业必投" |
...
| **DS** `business-model` 元假说 A：LLM 平台一旦自建广告位，c/d 层中介模式整体被腰斩 | [`geo-business-model-taxonomy-cn`](./geo-business-model-taxonomy-cn.md) | "GEO 是 AI 时代长期赛道" |
...
| **DS 子空缺：反 GEO 监测专题** | 元假说 C 的具体展开 | 已在 BACKLOG（`tech-cn-anti-geo-monitoring`） |
...
1. [`geo-business-model-taxonomy-cn`](./geo-business-model-taxonomy-cn.md) 第 II 节七层 × 6 维度全表
2. [`geo-demand-side-fitness-cn`](./geo-demand-side-fitness-cn.md)——判断目标客户是否在真买家区
3. 自检：本公司在七层中位置 / 平台原生功能取代风险 / 客户价值 vs 模式合理性四象限
