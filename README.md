...
- **18 张跨平台技术主题卡** + 1 张维度索引地图元卡（D0 需求侧 1 + D1-D8 信号侧 14 + DS 供给侧 1 主 + 2 子）
- **91 条元假说**——2026-05-04 元假说审计后判决 ✓ 28 / ◐ 17 / ✗ 9 / ? 32+5（[`audits/2026-05-04_meta-hypothesis-audit.md`](./audits/2026-05-04_meta-hypothesis-audit.md)）；信号侧 D1-D8 整体未被证伪；需求侧 D0 + 供给侧 DS 已升级为分层画像（D0 5 类窄场景 / DS 八层 + 头部 / 腰部 / 尾部分层）
- 7 张平台卡片（豆包 / DeepSeek / 文心 / 千问 / 元宝 / 小红书 / 百度）+ 1 张服务商话术拆解卡（探词科技样本 #1）
- 6 篇对外博客系列（约 14000 字，[`blog/`](./blog/)）
...
> ⭐ **新读者强烈建议先读** [`techniques/dimension-map-cn.md`](./techniques/dimension-map-cn.md) ——它把 18 张技术卡的 D0 + D1-D8 + DS 三轴图谱、卡间关系、强假说集、反话术索引一次性显式化。
...
3. **大量元假说未实证**：18 张技术卡共 91 条元假说仍以 `concept` 为主——2026-05-04 审计后判决 ✓ 28 / ◐ 17 / ✗ 9 / ? 32+5，但 ✓ / ◐ / ✗ 大多基于反转事实的逻辑外推而非 pilot 数据，pilot 仍是首要任务
